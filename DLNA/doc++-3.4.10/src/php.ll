...
<FindClasses,ClassName,Require,Include,Extends,Implements,FindMembers,Member,Args,Function,See,Author,Version,Param,Return,Exception,Precondition,Postcondition,Invariant>[ \t\n]*"/**""*"*[ \t]*	{
					lastContext = YY_START;
					lineCount();
					current->doc.clear();
					BEGIN(PHPDoc);
